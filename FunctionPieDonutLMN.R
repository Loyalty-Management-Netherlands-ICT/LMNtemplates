#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
# custom function for PieDonut (based of webr::PieDonut)             #
# Lydia de Haan                                                      #
# June 2024                                                          #
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
...
PieDonutLMN <- function (data,
                         ...
                         
  {
    ...
    df
    # mainCol = RColorBrewer::brewer.pal(nrow(df), name = palette_name) # original code
    mainCol = lmnpalette[1:(nrow(df))] # edit colorscheme here
    lmnpalette
    df$radius = r1
